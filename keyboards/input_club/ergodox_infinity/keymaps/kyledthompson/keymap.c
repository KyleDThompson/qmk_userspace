...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        // left handvrsn
        KC_ESC(KC_EQL),         KC_1,         KC_2,   KC_3,   KC_4,   KC_5,   KC_LEFT,
        KC_TAB,         KC_Q,         KC_W,   KC_E,   KC_R,   KC_T,   TG(NUMPAD),
 ...
 * |--------+------+------+------+------+------|      |           |      |------+------+------+------+------+--------|
   |        |      |      |      |      |      |      |           |      |      |      |  UP  |      |      |        | 
 * `--------+------+------+------+------+-------------'           `-------------+------+------+------+------+--------'
 *   |Grv/L1|  '"  |AltShf| Left | Right|                                       |  Up  | Down | RIGHT|   ]  | ~L1  |
 *   `----------------------------------'                                       `----------------------------------'
 *                                        ,-------------.       ,-------------.
 *                                        | CAD  | LGui |       | Alt  |Ctrl/Esc|
 *                                 ,------|------|------|       |------+--------+------.
